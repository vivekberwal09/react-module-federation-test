...
class Button extends (lib_app_react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  render() {
    ...
    return /*#__PURE__*/lib_app_react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/lib_app_react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "You clicked ", this.state.count, " times"), /*#__PURE__*/lib_app_react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
